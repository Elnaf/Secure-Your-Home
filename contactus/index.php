    ...
    <div class="content">
      <div class="left-side">
        ...
        <div class="email details">
          ...
          <div class="text-one">yuvasriravi.b2017@gmail.com</div>
          <div class="text-two"></div>
        </div>
      </div>
      <div class="right-side">
        <div class="topic-text">Send us a message</div>
        <p>If you require any work from us or have any questions about our services, please send us a message from this
